...
echo BUILD_DATE=$BUILD_DATE > $GIT_DIR/buildvars
echo LEGO_VERSION=$LEGO_VERSION >> $GIT_DIR/buildvars
echo DOCKER_IMAGE_VERSION=$DOCKER_IMAGE_VERSION >> $GIT_DIR/buildvars
